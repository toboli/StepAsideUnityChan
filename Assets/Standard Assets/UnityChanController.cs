...
public class UnityChanController : MonoBehaviour {
    ...
    private Animator myAnimator;//アニメーションをする

    private Rigidbody myRigidbody;//移動させる
    ...
    //右ボタン押下の判定
    private bool isRButtonDown = false;//is○○ってよく見るけど、どうしてこのネーミング？
    ...
    void Start () {
        ...
        //Speedに1を代入。UnityChanLocomotionsの設定では、
        //Speedパラメータが0.8以上の値の場合に走るアニメーション再生する
